<template>
	<div class="cart">
		<Header :column="iheader"></Header>
		
		<div class="carts">购物车功能暂未实现</div>
		
		<!-- 推荐 -->
		<div class="sj_main">
			<div class="sj_main_t">
				 <img src="../assets/img/cart/tit.jpg" alt="推荐" />
			</div>
			<div class="sj_main_b">
...
<style>
.carts{width:100%; height:1rem; line-height:1rem; text-align:center; margin-top: 1rem;}
</style>